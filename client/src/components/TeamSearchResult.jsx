...
class TeamSearchResult extends Component {
  ...
  renderApplyToTeamConfirmModal() {
    const {
      cancelApplyToTeam,
      id,
      player: { teamApplyingTo, id: playerId }
    } = this.props;
    if (!playerId) {
    ...
    return (
      <Modal show={teamApplyingTo === id}>
        ...
        <Modal.Footer>
          ...
          <Button
            bsStyle="success"
            onClick={() => this.props.submit("application")}
          >
            Apply
          </Button>
        </Modal.Footer>
  ...
  renderSignInRequiredModal() {
    ...
    return (
      <Modal show={teamApplyingTo === id}>
        ...
        <Modal.Body>
          <p>You need to sign in before you can apply to teams.</p>
          <p>
            <Button
  ...
  render() {
    ...
    const isLoading = Object.keys(fixtures).some(
      fixture => fixtures[fixture].isLoading
    );
    const lastUpdated = Object.keys(fixtures).every(
      fixture => fixtures[fixture].lastUpdated
    );
