  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>{`${
            team.team ? team.team.name : "Team Profile"
          } | Dota 2 Team Finder`}</title>
          ...
          <Row>
            <Col xs={4} sm={2}>
              <Image
                src={
                  team.team.logo_url
                    ? encodeLogoUrl(team.team.logo_url)
            ...
            <Col xs={8} sm={10}>
              ...
              {team.team.available_positions.length > 0 && (
                <div style={{ marginBottom: "1rem" }}>
                  ...
                  &nbsp;Recruiting:&nbsp;
                  <FixtureDisplay
                    value={team.team.available_positions}
                    fixture={positions}
                  />
                </div>
              )}
