...
import { tryDeleteTeamMember, tryPromoteToCaptain, cancelPromoteToCaptain, promoteToCaptain } from 'actions/teams'
...
class ManageTeamMembers extends Component {
    ...
    render() {
        const { team: teamInstance, team: { team }, player } = this.props
