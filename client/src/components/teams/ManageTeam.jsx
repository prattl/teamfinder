...
import ManageApplications from "components/teams/ManageApplications";
import ManageInvitations from "components/teams/ManageInvitations";
import ManageTeamMembers from "components/teams/ManageTeamMembers";
...
class ManageTeam extends Component {
  ...
  constructor(props) {
    ...
    this.handleDeleteTeamConfirmClick = this.handleDeleteTeamConfirmClick.bind(
      this
    );
    this.handleDeleteTeamCancelClick = this.handleDeleteTeamCancelClick.bind(
      this
    );
  ...
  handleLeaveTeamClick() {
    ...
    const teamMember = team.team_members.find(
      teamMember => teamMember.player.id === player.id
    );
  ...
  renderDeleteTeamConfirmModal() {
    ...
    return (
      <Modal show={confirmDelete}>
        ...
        <Modal.Footer>
          <Button bsStyle="link" onClick={this.handleDeleteTeamCancelClick}>
            Cancel
          </Button>
          <Button bsStyle="danger" onClick={this.handleDeleteTeamConfirmClick}>
            Delete
          </Button>
        </Modal.Footer>
      </Modal>
