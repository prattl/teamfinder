...
const description = "Find out more about the Dota 2 Team Finder, including how it works and recent updates."
    ...
    render() {
        return (
            <div>
                ...
                <p className='lead'>
                    This website was created to bring the Dota 2 community together and open opportunities for players
                    who are interested in finding a team to play with, whether it be for casual games or something
                    more competitive.
                </p>
                ...
                <Row>
                    <Col md={6}>
                        ...
                        <ol>
                            ...
                            <li>If you want to create your own team, click <Link to='/players'>Find Players</Link>
                                and invite them to apply.</li>
                        </ol>
                        <Alert>
